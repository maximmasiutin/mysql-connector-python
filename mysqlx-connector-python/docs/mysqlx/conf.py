# -*- coding: utf-8 -*-
#
# mysqlx documentation build configuration file, created by
...
# Use the $CPY_BUILD_DIR environment variable to set Connector/Python
# build path.
try:
    sys.path.insert(0, os.path.abspath(os.environ["CPY_BUILD_DIR"]))
except KeyError:
    cpy_dir = os.path.split(os.path.split(os.path.abspath("."))[0])[0]
...
version = "{0}.{1}".format(*VERSION[:2])
# The full version, including alpha/beta/rc tags.
release = "{0}.{1}.{2}".format(*VERSION[:3])
...
man_pages = [
    (
        master_doc,
        "mysqlxconnectorpythondevapireference",
        "MySQL Connector/Python X DevAPI Reference Documentation",
        [author],
        1,
    )
...
texinfo_documents = [
    (
        master_doc,
        "MySQLConnectorPythonXDevAPIReference",
        "MySQL Connector/Python X DevAPI Reference Documentation",
        author,
        "MySQLConnectorPythonXDevAPIReference",
        "MySQL Connector/Python X DevAPI Reference Documentation.",
